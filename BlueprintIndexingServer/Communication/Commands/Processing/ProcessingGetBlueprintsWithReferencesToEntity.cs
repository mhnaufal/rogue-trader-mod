...
public static class ProcessingGetBlueprintsWithReferencesToEntity
{
    public static Command? Processing(Command command, FileDatabase.FileDatabase database)
    {
        ...
        var ids = payloadData?.Id != null ? database.GetBlueprintsWithReferencesToEntity(payloadData.Id) : Enumerable.Empty<string>();

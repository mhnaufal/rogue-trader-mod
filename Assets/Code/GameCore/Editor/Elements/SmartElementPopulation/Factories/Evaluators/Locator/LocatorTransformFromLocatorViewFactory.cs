...
{
	[UsedImplicitly]
	public class LocatorTransformFromLocatorViewFactory : ElementFactory<LocatorTransform, LocatorView>
	{
		protected override void Populate(SimpleBlueprint owner, LocatorTransform element, LocatorView source)
		{
